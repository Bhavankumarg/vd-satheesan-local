    ...
    <>
      <div class="grid lg:grid-cols-2 grid-flow-row gap-4 bg-[url('/home_images/about_satheesan_background.png')] mx-auto p-5 mx-5">
        ...
        <div className="border border-4 border-[#033B5F] mt-5 text-center flex justify-center items-center lg:me-10">
          <div>
            <h6 className="text-[#035C96] text-[34px] font-semibold">
              Hello, I am{" "}
            </h6>
            <h6 className="text-[#035C96] text-[34px] font-semibold">
              VD Satheesan…
            </h6>
            <Button className="border border-4 border-sky-800 p-2 items-center justify-center bg-white rounded-sm text-[#035C96] text-lg  mt-5 w-40 mb-5">
              Know Me
            </Button>
          </div>
        </div>
