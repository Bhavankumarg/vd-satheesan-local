        ...
        <div className="mx-auto p-5">
          <div className="border-t-8 border-red-900 lg:flex">
            ...
            <h6 className="text-white text-lg lg:p-10 p-5 lg:w-3/5">
              There is no space for the conventional kind of opposition for the
              sake of opposing something in this era. We need to have a
              consensus and continuity in developmental activities”
            </h6>
            </div>
            <img className="hidden lg:block top-0 mt-52 p-5 bottom-0 right-0 absolute me-20" src="/sincere_images/si-2.png" />
          </div>
        </div>
      </div>
    </>
